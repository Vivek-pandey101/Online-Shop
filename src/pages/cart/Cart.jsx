...
function Cart() {
  ...
  let shipping = totalAmount <= 0 ? 0 : parseInt(100);
  ...
  const buyNow = async () => {
    ...
    var options = {
      ...
      handler: function (response) {
        ...
        try {
          const result = addDoc(collection(fireDataBase, "orders"), orderInfo);
        } catch (error) {
          console.log(error);
        }
      },
  ...
  return (
    <Layout>
      <div
        className="h-screen bg-gray-100 pt-5 h-[100%]"
        style={{
                ...
                >
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    ...
                    >
                      ...
                      <h2
                        className="text-sm  text-gray-900 ovelflow-hidden display-inline"
                        style={{ color: mode === "dark" ? "white" : "" }}
                      >
                        {item.description}
                      </h2>
